(function () {
    ...
    define("ace/lib/useragent", ["require", "exports", "module"], function (e, t, n) {
        ...
        t.isWin = i == "win",
            ...
            t.isSafari = parseFloat(s.split(" Safari/")[1]) && !t.isChrome || undefined,
    ...
    define("ace/lib/default_english_messages", ["require", "exports", "module"], function (e, t, n) {
        var r = {
    ...
    define("ace/lib/app_config", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/report_error", "ace/lib/default_english_messages"], function (e, t, n) {
        "no use strict";
        function a(e) {
        ...
        var r = e("./oop"),
            ...
            c = function () {
                ...
                return e.prototype.defineOptions = function (e, t, n) {
                    ...
                    f = e,
                        t && t.placeholders && (l = t.placeholders)
        ...
        t.setLoader = function (e) {
            ...
            t.loadModule = function (e, n) {
                ...
                var u = function (e) {
                    if (e && !t.$loading[o])
                        return n && n(e);
                    t.$loading[o] || (t.$loading[o] = []),
                        t.$loading[o].push(n);
                    if (t.$loading[o].length > 1)
                        return;
                    var r = function () {
                        a(o, function (e, n) {
                            n && (t.$loaded[o] = n),
                    ...
                    if (!t.get("packaged"))
                        return r();
                    i.loadScript(t.moduleUrl(o, s), r),
                        l()
                };
    ...
    define("ace/lib/keys", ["require", "exports", "module", "ace/lib/oop"], function (e, t, n) {
        ...
        for (var o = 65; o < 91; o++) {
            ...
            s["Key" + u.toUpperCase()] = o,
                i.PRINTABLE_KEYS[o] = u
        }
        for (var o = 1; o < 13; o++)
            s["F" + o] = 111 + o,
                i.FUNCTION_KEYS[111 + o] = "F" + o;
        var a = {
            Shift: 16,
            Control: 17,
            Alt: 18,
    ...
    define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/config", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/clipboard", "ace/lib/keys"], function (e, t, n) {
        ...
        y = function (e, t) {
            ...
            function Y(e) {
                e.keyCode == 27 && n.value.length < n.selectionStart && (w || (N = n.value), C = k = -1, H()),
                    G()
            }
            function et() {
                clearTimeout(Z),
            ...
            function nt(e, t, n) {
                ...
                var s = function (e) {
                    if (document.activeElement !== n)
                        return;
                    if (i || w || t.$mouseHandler.isMousePressed)
                        return;
                    if (y)
                        return;
            ...
            this.setNumberOfExtraLines = function (e) {
                ...
                this.setAriaLabel = function () {
                    ...
                    if (t.session) {
                        ...
                        e += i("text-input.aria-label", "Cursor at row $0", [r + 1])
                    }
                    n.setAttribute("aria-label", e)
                },
                this.setAriaOptions = function (e) {
                    e.activeDescendant ? (n.setAttribute("aria-haspopup", "true"), n.setAttribute("aria-autocomplete", e.inline ? "both" : "list"), n.setAttribute("aria-activedescendant", e.activeDescendant)) : (n.setAttribute("aria-haspopup", "false"), n.setAttribute("aria-autocomplete", "both"), n.removeAttribute("aria-activedescendant")),
                        e.role && n.setAttribute("role", e.role),
                        e.setLabel && (n.setAttribute("aria-roledescription", i("text-input.aria-roledescription", "editor")), this.setAriaLabel())
                },
                this.setAriaOptions({
                    role: "textbox"
                }),
                    ...
                    if (r) {
                        ...
                        while (o && o.nodeType == 1)
                            s.push(o),
                                ...
                                !o.parentElement && o.getRootNode ? o = o.getRootNode().host : o = o.parentElement
                    }
                    n.focus({
                        preventScroll: !0
                    }),
            ...
            var I = !1,
                q = function (e, r) {
                    ...
                    f = f.slice(h),
                        h = 1;
                    while (a > 0 && N.length - h > C - 1 && N[N.length - h] == e[e.length - h])
                        h++,
                            a--;
                    l -= h - 1,
                        c -= h - 1;
            ...
            var $ = function (e) {
                if (w || !t.onCompositionStart || t.$readOnly)
                    return;
                w = {};
                if (x)
                    return;
                ...
                r.end.row = r.start.row,
                    ...
                    w.useTextareaForIME ? (N = n.value = "", C = 0, k = 0) : (n.msGetInputContext && (w.context = n.msGetInputContext()), n.getInputContext && (w.context = n.getInputContext()))
            },
                J = function () {
                    ...
                    if (w.useTextareaForIME)
                        ...
                        var e = n.value;
                        q(e),
                            w.markerRange && (w.context && (w.markerRange.start.column = w.selectionStart = w.context.compositionStartOffset), w.markerRange.end.column = w.markerRange.start.column + k - w.selectionStart + L)
                    }
                },
                K = function (e) {
            ...
            r.addListener(n, "compositionstart", $, t),
                ...
                this.moveToMouse = function (e, i) {
                    S || (S = n.style.cssText),
                        n.style.cssText = (i ? "z-index:100000;" : "") + (s.isIE ? "opacity:0.1;" : "") + "text-indent: -" + (C + k) * t.renderer.characterWidth * .5 + "px;";
                    var u = t.container.getBoundingClientRect(),
                        a = o.computedStyle(t.container),
                        f = u.top + (parseInt(a.borderTopWidth) || 0),
                        l = u.left + (parseInt(a.borderLeftWidth) || 0),
            ...
            o = function () {
                ...
                return e.prototype.onMouseDown = function (e) {
                    ...
                    n.t = r,
                        ...
                        n.vy = u;
                    if (f)
                        return t.renderer.scrollBy(e.wheelX * e.speed, e.wheelY * e.speed), e.stop()
                }, e
            }();
    ...
    define("ace/lib/scroll", ["require", "exports", "module"], function (e, t, n) {
    ...
    define("ace/tooltip", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/range", "ace/lib/scroll"], function (e, t, n) {
        "use strict";
        ...
        var p = function (e) {
            ...
            return r(t, e), t.prototype.addToEditor = function (e) {
                ...
                this.timeout = null,
                    this.lastEvent && !this.isOutsideOfText(this.lastEvent) && this.$gatherData(this.lastEvent, this.lastEvent.editor)
                ...
                var i = 10;
                if (r && r != this.lastEvent)
                    return;
                if (this.isOpen && document.activeElement == this.getElement())
                    return;
                var s = e.renderer;
                this.isOpen || (h.addPopup(this), this.$registerCloseEvents(), this.setTheme(s.theme)),
                    this.isOpen = !0,
                ...
                o.pageY - l < 0 && o.pageY < p && (d = !1),
                    ...
                    f.style.left = Math.min(o.pageX, window.innerWidth - c - i) + "px"
    ...
    define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/tooltip", "ace/config"], function (e, t, n) {
        ...
        function c(e) {
            function a() {
                ...
                if (e.$tooltipFollowsMouse)
                    ...
                    var h = u.getGutterRow(),
                        d = n.$lines.get(h);
                    if (d) {
                        var v = d.element.querySelector(".ace_gutter_annotation"),
                            m = v.getBoundingClientRect(),
                            g = r.getElement().style;
                        g.left = m.right - f + "px",
                            g.top = m.bottom - l + "px"
                    } else
                        p(u)
            ...
            function c(e) {
                if (e && e.type === "keydown" && (e.ctrlKey || e.metaKey))
                    return;
                if (e && e.type === "mouseout" && (!e.relatedTarget || r.getElement().contains(e.relatedTarget)))
                    return;
                i && (i = clearTimeout(i)),
                    r.isOpen && (r.hideTooltip(), t.off("mousewheel", c), t.off("changeSession", c), window.removeEventListener("keydown", c, !0))
            }
            function p(e) {
            ...
            e.editor.setDefaultHandler("guttermousemove", function (t) {
                ...
                if (s.hasCssClass(n, "ace_fold-widget") || s.hasCssClass(n, "ace_custom-widget"))
                    return c();
                r.isOpen && e.$tooltipFollowsMouse && p(t),
                    u = t;
                if (i)
                    return;
                i = setTimeout(function () {
                    i = null,
                        u && !e.isMousePressed && a()
                }, 50)
            }),
        ...
        var r = this && this.__extends || function () {
            ...
            f = 5,
            l = 3;
        t.GUTTER_TOOLTIP_LEFT_OFFSET = f,
            t.GUTTER_TOOLTIP_TOP_OFFSET = l,
            t.GutterHandler = c;
        var h = function (e) {
            function t(t, n) {
                n === void 0 && (n = !1);
            ...
            return r(t, e), t.prototype.onMouseOut = function (e) {
                ...
                for (var c = 0; c < o.displayText.length; c++) {
                    var g = s.createElement("span"),
                        y = s.createElement("span");
                    (n = y.classList).add.apply(n, ["ace_".concat(o.type[c]), m]),
                        y.setAttribute("aria-label", "".concat(t.annotationLabels[o.type[c].replace("_fold", "")].singular)),
                        y.setAttribute("role", "img"),
                        y.appendChild(s.createTextNode(" ")),
                        g.appendChild(y),
                        g.appendChild(s.createTextNode(o.displayText[c])),
                        g.appendChild(s.createElement("br")),
                        v[o.type[c].replace("_fold", "")].push(g)
                }
                var b = this.getElement();
                s.removeChildren(b),
                    v.error.forEach(function (e) {
                    ...
                    this.isOpen || (this.setTheme(this.editor.renderer.theme), this.setClassName("ace_gutter-tooltip")),
                    this.show(),
            ...
            s = function () {
                ...
                return e.prototype.stopPropagation = function () {
                    ...
                    var e = this.getDocumentPosition().row,
                        ...
                        n = this.editor.session.documentToScreenRow(this.editor.renderer.$gutterLayer.$lines.get(0).row, 0);
                    return t - n
        ...
        t.addTouchListeners = function (e, t) {
            function b() {
                var e = window.navigator && window.navigator.clipboard,
                    ...
                    i = function () {
                        ...
                        y.replaceChild(s.buildDom(r ? ["span", !n && o("selectall") && ["span", {
                            "class": "ace_mobile-button",
                            action: "selectall"
                        }, "Select All"], n && o("copy") && ["span", {
                            "class": "ace_mobile-button",
                            action: "copy"
                        }, "Copy"], n && o("cut") && ["span", {
                            "class": "ace_mobile-button",
                            ...
                            "class": "ace_mobile-button",
                            action: "find"
                        }, "Find"], o("openCommandPalette") && ["span", {
                            "class": "ace_mobile-button",
                            action: "openCommandPalette"
                        }, "Palette"]] : ["span"]), y.firstChild)
                    },
                    o = function (e) {
            ...
            function w() {
                ...
                y.style.top = n.pageY - s.top - 3 + "px",
                    n.pageX - s.left < s.width - 70 ? (y.style.left = "", y.style.right = "10px") : (y.style.right = "", y.style.left = r + i - s.left + "px"),
                    y.style.display = "",
                    y.firstChild.style.display = "none",
                    t.on("input", E)
            }
            ...
            i.addListener(e, "contextmenu", function (e) {
                ...
                i.addListener(e, "touchend", function (e) {
                    g = t.$mouseHandler.isMousePressed = !1,
                        c && clearInterval(c),
                        n == "zoom" ? (n = "", h = 0) : l ? (t.selection.moveToPosition(p), h = 0, w()) : n == "scroll" ? (T(), E()) : w(),
                        clearTimeout(l),
                        l = null
                }, t),
            ...
            c = function () {
                function e(e) {
                    ...
                    r.addListener(l, "mousedown", this.onMouseEvent.bind(this, "guttermousedown"), e),
                        ...
                        i.isIE && e.renderer.scrollBarV && (r.addListener(e.renderer.scrollBarV.element, "mousedown", n, e), r.addListener(e.renderer.scrollBarH.element, "mousedown", n, e)),
                ...
                this.add("braces", "insertion", function (t, n, r, i, s) {
                    ...
                    if (s == "{") {
                        ...
                        if (v && /(?:string)\.quasi|\.xml/.test(v.type)) {
                            ...
                            }) || /(string)\.quasi/.test(v.type) && v.value[u.column - v.start - 1] !== "$")
                                return;
                        ...
                        if (d.isSaneInsertion(r, i))
                            return /[\]\}\)]/.test(a[u.column]) || r.inMultiSelectMode || e.braces ? (d.recordAutoInsert(r, i, "}"), {
                                text: "{}",
                                selection: [1, 1]
            ...
            i = function () {
                ...
                return e.prototype.getRowLength = function (e) {
                    ...
                    e.html && !e.el && (e.el = r.createElement("div"), e.el.innerHTML = e.html),
                        e.text && !e.el && (e.el = r.createElement("div"), e.el.textContent = e.text),
                        e.el && (r.addCssClass(e.el, "ace_lineWidgetContainer"), e.className && r.addCssClass(e.el, e.className), e.el.style.position = "absolute", e.el.style.zIndex = "5", t.container.appendChild(e.el), e._inDocument = !0, e.coverGutter || (e.el.style.zIndex = "3"), e.pixelHeight == null && (e.pixelHeight = e.el.offsetHeight)),
            ...
            s = function () {
                ...
                return e.prototype.setRegexp = function (e) {
                    ...
                    var o = s.firstRow,
                        ...
                        a = {},
                        f = n.$editor.$search,
                        l = f.$isMultilineSearch(n.$editor.getLastSearchOptions());
                    for (var c = o; c <= u; c++) {
                        var h = this.cache[c];
                        if (h == null || n.getValue().length != this.docLen) {
                            if (l) {
                                ...
                                if (p) {
                                    ...
                                    d > c && (c = d),
                                        h.push(new i(p.startRow, p.startCol, p.endRow, p.endCol))
                                }
                        ...
                        for (var v = h.length; v--;) {
                            ...
                            if (a[g])
                                continue;
                            a[g] = !0,
                                t.drawSingleLineMarker(e, m, this.clazz, s)
                        }
                    }
                    this.docLen = n.getValue().length
                }, e
            }();
        s.prototype.MAX_RANGES = 500,
            t.SearchHighlight = s
    }),
        ...
        function a() {
            this.getFoldAt = function (e, t, n) {
                ...
                this.$toggleFoldWidget = function (e, t) {
                    ...
                    if (s)
                        return t.children || t.all ? this.removeFold(s) : this.expandFold(s), s;
            ...
            this.findMatchingBracket = function (e, t) {
                ...
                this.$findTagName = function (e) {
                    ...
                    if (t && t.type.indexOf("tag-name") === -1)
                        do r ? t = e.stepBackward() : t = e.stepForward(),
                ...
                this.$findClosingTag = function (e, t) {
                    var n,
                        ...
                        s = t.value,
                        o = 0,
                        u = new i(e.getCurrentTokenRow(), e.getCurrentTokenColumn(), e.getCurrentTokenRow(), e.getCurrentTokenColumn() + 1);
                    t = e.stepForward();
                    var a = new i(e.getCurrentTokenRow(), e.getCurrentTokenColumn(), e.getCurrentTokenRow(), e.getCurrentTokenColumn() + t.value.length),
                        f = !1;
                    do {
                        n = t;
                            ...
                            if (t.type.indexOf("tag-name") !== -1) {
                                if (r === t.value)
                                    if (n.value === "<") {
                                        ...
                                        if (s > 0) {
                                            var h = new i(o, u, o, a),
                                                p = new i(e.getCurrentTokenRow(), e.getCurrentTokenColumn(), e.getCurrentTokenRow(), e.getCurrentTokenColumn() + 1);
                                            do t = e.stepForward();
                                            while (t && t.value !== ">");
                ...
                return e.prototype.$initOperationListeners = function () {
                    ...
                    this.curOp = null,
                        this.on("change", function () {
                            e.curOp || (e.startOperation(), e.curOp.selectionBefore = e.$lastSel),
                        ...
                        this.$operationResetTimer = i.delayedCall(this.endOperation.bind(this, !0))
                    ...
                    for (i = 0; i < e.length; i++) {
                        r = e.charCodeAt(i),
                            r == 9 ? n += this.getScreenTabSize(n) : r >= 4352 && N(r) ? n += 2 : n += 1;
                        if (n > t)
                            break
                    }
                    return [n, i]
                    ...
                    this.destroyed || (this.bgTokenizer.setDocument(null), this.bgTokenizer.cleanup(), this.destroyed = !0),
                        ...
                        this.removeAllListeners(),
                        this.doc && this.doc.off("change", this.$onChange),
                        this.selection && (this.selection.off("changeCursor", this.$onSelectionChange), this.selection.off("changeSelection", this.$onSelectionChange)),
        ...
        function u(e, t) {
            function i(e, r) {
                ...
                if (i.test(e) || t.regExp)
                    return n && t.$supportsUnicodeFlag ? r ? "(?<=^|[^\\p{L}\\p{N}_])" : "(?=[^\\p{L}\\p{N}_]|$)" : "\\b";
                return ""
            }
        ...
        var r = e("./lib/lang"),
            ...
            o = function () {
                ...
                return e.prototype.set = function (e) {
                        ...
                        for (var g, y = 0; y < i.length; y++)
                            if (this.$isMultilineSearch(t)) {
                                ...
                                if (g) {
                                    ...
                                    w > y && (y = w),
                                        o.push(new s(g.startRow, g.startCol, g.endRow, g.endCol))
                                }
                            } else {
                    ...
                    i && (e = e.replace(/\r\n|\r|\n/g, "\n"));
                    var s = r.exec(e);
                    if (!s || !i && s[0].length != e.length)
                        return null;
                    t = n.regExp ? this.parseReplaceString(t) : t.replace(/\$/g, "$$$$"),
                        t = e.replace(r, t);
                    if (n.preserveCase) {
                        t = t.split("");
                    ...
                    for (var o = n; o <= r;) {
                        ...
                        if (l) {
                            var c = i.slice(0, l.index).split("\n"),
                                ...
                                v = p + h.length - 1,
                                m = h.length == 1 ? d + h[0].length : h[h.length - 1].length;
                            return {
                                startRow: p,
                                startCol: d,
                                endRow: v,
                    ...
                    for (var l = r; l >= i;) {
                        ...
                        if (p) {
                            var d = s.slice(0, p.index).split("\n"),
                                ...
                                y = m + v.length - 1,
                                b = v.length == 1 ? g + v[0].length : v[v.length - 1].length;
                            return {
                                startRow: m,
                                startCol: g,
                                endRow: y,
            ...
            s = function () {
                ...
                return e.prototype.addListener = function () {
                    ...
                    if (this.annotationTooltip.isOpen) {
                        e.preventDefault(),
                            e.keyCode === r.escape && this.annotationTooltip.hideTooltip();
                        return
                    }
                    if (e.target === this.element) {
                        ...
                        this.editor.isRowVisible(t) || this.editor.scrollToLine(t, !0, !0),
                            setTimeout(function () {
                    ...
                    if (e.keyCode === r.enter || e.keyCode === r.space) {
                        ...
                        switch (this.activeLane) {
                            case "fold":
                                ...
                                return;
                            case "annotation":
                                var i = this.lines.cells[this.activeRowIndex].element.childNodes[2],
                    ...
                    while (e > 0) {
                        ...
                        if (this.$isFoldWidgetVisible(e) || this.$isCustomWidgetVisible(e)) {
                            this.$blurFoldWidget(this.activeRowIndex),
                                ...
                                this.$isFoldWidgetVisible(e) ? this.$focusFoldWidget(this.activeRowIndex) : this.$focusCustomWidget(this.activeRowIndex);
                            return
                        }
                    }
                    return
                    ...
                    switch (e) {
                        ...
                        case "fold":
                            ...
                            this.activeLane = "fold",
                                this.$blurAnnotation(this.activeRowIndex),
                                this.activeRowIndex = n,
                                this.$isCustomWidgetVisible(n) ? this.$focusCustomWidget(this.activeRowIndex) : this.$focusFoldWidget(this.activeRowIndex)
                    }
                    return
    ...
    define("ace/editor", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator", "ace/keyboard/gutter_handler", "ace/config", "ace/clipboard", "ace/lib/keys", "ace/lib/event", "ace/tooltip"], function (e, t, n) {
            ...
            C = function () {
                function e(t, n, r) {
                    ...
                    this.container = i,
                        ...
                        typeof document == "object" && (this.textInput = new a(t.getTextAreaContainer(), this), this.renderer.textarea = this.textInput.getElement(), this.$mouseHandler = new f(this), new l(this)),
                ...
                return e.prototype.$initOperationListeners = function () {
                    ...
                    this.$highlightPending = !0,
                        setTimeout(function () {
                            ...
                            Array.isArray(s) ? s.length == 1 && (f = "ace_error_bracket") : s = [s],
                                s.length == 2 && (d.comparePoints(s[0].end, s[1].start) == 0 ? s = [d.fromPoints(s[0].start, s[1].end)] : d.comparePoints(s[0].start, s[1].end) == 0 && (s = [d.fromPoints(s[1].start, s[0].end)])),
                                t.$bracketHighlight = {
                                    ranges: s,
                    ...
                    n.insert(i, e),
                        s && s.selection && (s.selection.length == 2 ? this.selection.setSelectionRange(new d(i.row, f + s.selection[0], i.row, f + s.selection[1])) : this.selection.setSelectionRange(new d(i.row + s.selection[0], s.selection[1], i.row + s.selection[2], s.selection[3])));
                    ...
                    var e = this.session,
                        t = e.getMode(),
                        n = this.selection.isEmpty() ? [new d(0, 0, e.doc.getLength() - 1, 0)] : this.selection.getAllRanges(),
                        r = "",
                        i = "",
                        s = "",
                        o = e.getTabString();
                    ...
                    if (t.extendLeft || t.extendRight) {
                        ...
                        n.start.column -= t.extendLeft,
                            ...
                            n.start.column < 0 && (n.start.row--, n.start.column += this.session.getLine(n.start.row).length + 1),
                    ...
                    var n = this.session.getLine(e.row),
                        r,
                        i;
                    t < n.length ? (r = n.charAt(t) + n.charAt(t - 1), i = new d(e.row, t - 1, e.row, t + 1)) : (r = n.charAt(t - 1) + n.charAt(t - 2), i = new d(e.row, t - 2, e.row, t)),
                    ...
                    n.match(/[A-Za-z0-9_]+/) && i.forEach(function (t, i) {
                        a = u + t.length,
                            s >= u && s <= a && (n = t, f.selection.clearSelection(), f.moveCursorTo(e, u + r), f.selection.selectTo(e, a + r)),
                            u = a
                    });
                    ...
                    do {
                        if (o.value.match(/[{}()\[\]]/g))
                            for (; l < o.value.length && !a; l++) {
                                if (!h[o.value[l]])
                                    continue;
                                c = h[o.value[l]] + "." + o.type.replace("rparen", "lparen"),
                                    isNaN(f[c]) && (f[c] = 0);
                                switch (o.value[l]) {
                                    case "(":
                                    case "[":
                    ...
                    if (u === "bracket") {
                        ...
                        if (!p) {
                            p = new d(r.getCurrentTokenRow(), r.getCurrentTokenColumn() + l - 1, r.getCurrentTokenRow(), r.getCurrentTokenColumn() + l - 1),
                                v = p.start;
                    ...
                    v = p && p.cursor || v,
                        v && (e ? p && t ? this.selection.setRange(p) : p && p.isEqual(this.getSelectionRange()) ? this.clearSelection() : this.selection.selectTo(v.row, v.column) : this.selection.moveTo(v.row, v.column))
        ...
        C.$uid = 0,
            ...
            C.prototype.$toggleWordPairs = [["first", "last"], ["true", "false"], ["yes", "no"], ["width", "height"], ["top", "bottom"], ["right", "left"], ["on", "off"], ["x", "y"], ["get", "set"], ["max", "min"], ["horizontal", "vertical"], ["show", "hide"], ["add", "remove"], ["up", "down"], ["before", "after"], ["even", "odd"], ["in", "out"], ["inside", "outside"], ["next", "previous"], ["increase", "decrease"], ["attach", "detach"], ["&&", "||"], ["==", "!="]],
                ...
                readOnly: {
                    set: function (e) {
                        ...
                        this.textInput.setReadOnly(e),
                            ...
                            this.$readOnlyCallback || (this.$readOnlyCallback = function (e) {
                                var n = !1;
                                if (e && e.type == "keydown") {
                                ...
                                if (n) {
                                    ...
                                    r.textContent = E("editor.tooltip.disable-editing", "Editing is disabled"),
                                        t.hoverTooltip.isOpen || t.hoverTooltip.showForRange(t, t.getSelectionRange(), r)
                                } else
                                    t.hoverTooltip && t.hoverTooltip.isOpen && t.hoverTooltip.hide()
                            });
                ...
                return e.prototype.setSession = function (e) {
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        o = o ? s.escapeHTML(o) : n.html || "",
                            u = u ? u : n.html || "",
                            i.text.indexOf(o) === -1 && (i.text.push(o), i.type.push(a), i.displayText.push(u));
                        var f = n.className;
                    ...
                    for (; ;) {
                        ...
                        o = this.$lines.get(++u),
                            o ? o.row = a : (o = this.$lines.createCell(a, e, this.session, l), this.$lines.push(o)),
                    ...
                    this.$highlightGutterLine && (i == this.$cursorRow || n && i < this.$cursorRow && i >= y && this.$cursorRow <= n.end.row) && (w += "ace_gutter-active-line ", this.$cursorCell != e && (this.$cursorCell && (this.$cursorCell.element.className = this.$cursorCell.element.className.replace("ace_gutter-active-line ", "")), this.$cursorCell = e)),
                        d[i] && (w += d[i]),
                        v[i] && (w += v[i]),
                        this.$annotations[i] && i !== y && (w += this.$annotations[i].className);
                    if (g) {
                        var x = g[i];
                    ...
                    if (x) {
                        ...
                        f && (r.setStyle(f.style, "display", "none"), f.setAttribute("tabindex", "0"), f.removeAttribute("role"), f.removeAttribute("aria-label"));
                    ...
                    if (k && this.$showFoldedAnnotations) {
                        ...
                        l.className = "ace_gutter_annotation",
                            h.className = E,
                            this.$useSvgGutterIcons ? h.className += this.$annotations[i].className : s.classList.add(this.$annotations[i].className.replace(" ", "")),
                            r.setStyle(h.style, "height", b),
                            r.setStyle(l.style, "display", "block"),
                            r.setStyle(l.style, "height", b);
                        var M;
                        switch (this.$annotations[i].className) {
                            ...
                            case " ace_info":
                                ...
                                break;
                            case " ace_hint":
                                M = a("gutter.annotation.aria-label.hint", "Suggestion, read annotations row $0", [S])
                        }
                        l.setAttribute("aria-label", M),
                            l.setAttribute("tabindex", "-1"),
                            l.setAttribute("role", "button")
                    ...
                    var t = this.$lines.cells,
                        n = this.session.documentToScreenRow(e, 0);
                    ...
                    if (a && a.element) {
                        ...
                        f && f.remove(),
                            ...
                            u && u.onClick && f.addEventListener("click", function (t) {
                                u.onClick(t, e),
                                    t.stopPropagation()
                            }),
                ...
                return e.prototype.setPadding = function (e) {
                    ...
                    for (; l <= f; l++)
                        d.start.row = d.end.row = l,
                            d.start.column = l == a ? t.start.column : u.getRowWrapIndent(l),
                            d.end.column = p,
                            c = h,
                            h = p,
                            p = l + 1 < f ? u.getScreenLastRowColumn(l + 1) : l == f ? 0 : t.end.column,
                            this.drawSingleLineMarker(e, d, n + (l == a ? " ace_start" : "") + " ace_br" + o(l == a || l == a + 1 && t.start.column, c < h, h > p, l == f), i, l == f ? 0 : 1, s)
                    ...
                    if (this.session.$bidiHandler.isBidiRow(t.start.row)) {
                        ...
                        this.elt(n + " ace_br1 ace_start", "height:" + o + "px;" + "right:" + s + "px;" + "top:" + u + "px;left:" + a + "px;" + (i || ""));
    ...
    define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/layer/lines", "ace/lib/event_emitter", "ace/config", "ace/layer/text_util"], function (e, t, n) {
        "use strict";
        var r = e("../lib/oop"),
            i = e("../lib/dom"),
            s = e("../lib/lang"),
                ...
                return e.prototype.$updateEolChar = function () {
                    ...
                    while (l = o.exec(r)) {
                        ...
                        if (h) {
                            ...
                            u.appendChild(i.$tabStrings[y].cloneNode(!0)),
                                t += y - 1
                        } else if (p)
                            if (i.showSpaces) {
                            ...
                            var b = this.dom.createElement("span");
                            b.className = "ace_invisible ace_invisible_space ace_invalid",
                            ...
                            b.style.width = i.config.characterWidth * 2 + "px",
                                b.className = i.showSpaces ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk",
                    ...
                    if (!f(n.type)) {
                        ...
                        n.type == "fold" && (b.style.width = n.value.length * this.config.characterWidth + "px", b.setAttribute("title", a("inline-fold.closed.title", "Unfold code"))),
                            b.className = w,
                            b.appendChild(u),
                            e.appendChild(b)
                    } else
                    ...
                    if (i) {
                        ...
                        for (var o = 0; o < s.length; o++)
                            if (t.row !== s[o].start.row) {
                                this.$highlightIndentGuideMarker.end = s[o].start.row + 1,
                                    t.row > s[o].start.row ? this.$highlightIndentGuideMarker.dir = -1 : this.$highlightIndentGuideMarker.dir = 1;
                                break
                            }
                    }
            ...
            i = function () {
                ...
                return e.prototype.$updateOpacity = function (e) {
                    ...
                    clearInterval(this.intervalId),
                        ...
                        this.smoothBlinking && (this.$isSmoothBlinking = !1, r.removeCssClass(this.element, "ace_smooth-blinking")),
                        e(!0);
    ...
    define("ace/scrollbar", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/event_emitter"], function (e, t, n) {
        ...
        var l = function (e) {
            ...
            return r(t, e), t.prototype.onScroll = function () {
                ...
                this.scrollHeight = e,
                    e > a ? (this.coeff = a / e, e = a) : this.coeff != 1 && (this.coeff = 1),
        ...
        var f = function (e) {
            ...
            return r(t, e), t.prototype.onMouseDown = function (e, t) {
                ...
                this.pageHeight = e,
                    ...
                    this.scrollTop > this.pageHeight - this.viewHeight && (this.scrollTop = this.pageHeight - this.viewHeight, this.scrollTop < 0 && (this.scrollTop = 0), this._emit("scroll", {
                        data: this.scrollTop
                    }))
            }, t.prototype.setScrollTop = function (e) {
                this.scrollTop = e,
        ...
        var l = function (e) {
            ...
            return r(t, e), t.prototype.onMouseDown = function (e, t) {
                ...
                this.pageWidth = e,
                    ...
                    this.scrollLeft > this.pageWidth - this.viewWidth && (this.scrollLeft = this.pageWidth - this.viewWidth, this.scrollLeft < 0 && (this.scrollLeft = 0), this._emit("scroll", {
                        data: this.scrollLeft
                    }))
            }, t.prototype.setScrollLeft = function (e) {
                this.scrollLeft = e,
                    ...
                    if (s) {
                        ...
                        for (var a = 0; a < s.length; a++) {
                            ...
                            if (d < this.minDecorationHeight) {
                                var v = (h + p) / 2 | 0;
                                v < this.halfMinDecorationHeight ? v = this.halfMinDecorationHeight : v + this.halfMinDecorationHeight > this.canvasHeight && (v = this.canvasHeight - this.halfMinDecorationHeight),
        ...
        var S = function () {
            function e(e, t) {
                ...
                this.canvas = r.element,
                    ...
                    this.$loop = new v(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView),
            ...
            return e.prototype.updateCharacterSize = function () {
                ...
                if (s.length > 1) {
                    ...
                    s.slice(1).forEach(function (e) {
                        ...
                        u.forEach(function (e) {
                            ...
                            E(e.type) || (t.className = "ace_" + e.type.replace(/\./g, " ace_")),
                ...
                for (var o = 0; o < i.length; o++) {
                    var u = this.session.$getDisplayTokens(i[o], t.column),
                        a = this.session.$computeWrapSplits(u, r, this.session.$tabSize);
                    if (a.length > 0) {
                        var f = 0;
                        a.push(i[o].length);
                        for (var l = 0; l < a.length; l++) {
                ...
                this.removeExtraToken(e.row, e.column),
                    this.$ghostTextWidget && (this.session.widgetManager.removeLineWidget(this.$ghostTextWidget), this.$ghostTextWidget = null),
                    this.$ghostText = null
                ...
                function s(r) {
                    ...
                    n.$padding && s != n.$padding && n.setPadding(s),
                        ...
                        t && t(),
                        w.isSafari && n.scroller && (n.scroller.style.background = "red", n.scroller.style.background = "")
                }
                var n = this;
                this.$themeId = e,
                ...
                this.$horizScroll = this.$vScroll = null,
                    ...
                    e === !0 ? (this.scrollBarV = new d(this.container, this), this.scrollBarH = new p(this.container, this), this.scrollBarV.setHeight(this.$size.scrollerHeight), this.scrollBarH.setWidth(this.$size.scrollerWidth), this.scrollBarV.addEventListener("scroll", function (e) {
        ...
        (function () {
            ...
            e("./config").defineOptions(d.prototype, "editor", {
                enableMultiselect: {
                    set: function (e) {
                        m(this),
                            e ? this.on("mousedown", o) : this.off("mousedown", o)
                    },
                    value: !0
                },
                enableBlockSelect: {
    ...
    define("ace/ext/error_marker", ["require", "exports", "module", "ace/lib/dom", "ace/range", "ace/config"], function (e, t, n) {
        ...
        function u(e, t, n) {
            ...
            s < 0 && (s = -s - 1),
                s >= r.length ? s = n > 0 ? 0 : r.length - 1 : s === 0 && n < 0 && (s = r.length - 1);
            var u = r[s];
            if (!u || !n)
                return;
            if (u.row === t) {
        ...
        t.showErrorMarker = function (e, t) {
            ...
            if (f) {
                var c = f[0];
                i.column = (c.pos && typeof c.column != "number" ? c.pos.sc : c.column) || 0,
                    i.row = c.row,
            ...
            d.style.left = v + e.renderer.gutterWidth - 5 + "px",
                ...
                l.displayText.forEach(function (e, t) {
                    p.appendChild(r.createTextNode(e)),
                        t < l.displayText.length - 1 && p.appendChild(r.createElement("br"))
                }),
